...
\label{sec:approach}
    ...
    \preston{Maybe cut this paragraph in favor of the following example}
    ...
    \preston{Concrete example from one of the anomalies}
   ...
   % call sequence,
    ...
    \preston{Our implementation of CrashSimulator uses {\tt strace} to accomplish the
    ...
    easily modify an {\tt strace} recording in order to express an anomaly in
    terms of system call results and side effects.}
    ...
    the application has carried out the operation in question.  \preston{To
    ...
    CrashSimulator}
    use a model (e.g. a deterministic finite
    ...
    \preston{We chose to implement checkers using enhanced finite automata because it seemed
    a good fit for analyzing a stream of system calls as they occurred.  In reality,
