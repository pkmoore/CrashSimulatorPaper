\section{CrashSimulator Approach }
	...
	can be used with applications written in a wide variety of languages.
   ...
   In many situations
    ...
    concludes, CrashSimulator able to use the ending state of the checker to
    ...
    can be expected to behave diffently when
    ...
    \phyllis{similar text in Eval is redundant. Leave this here and refer back to it from eval}
