...
\cappos{perhaps include this quote}
“No Battle Plan Survives Contact With the Enemy” Helmuth von Moltke

No matter how well an application is tested before being released, new 
bugs always seem to be found after deployment.  \cappos{quotes about this.
1/2 of MS employees are testers, formally verified systems failing in practice,
etc.}
