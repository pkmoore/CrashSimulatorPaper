\begin{abstract}
  ...
  application's developer with an idea of how the application would respond were
  it executed in the environment from which the test cases were
  generated. CrashSimulator was able to identify bugs resulting from anomalous
