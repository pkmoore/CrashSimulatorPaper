...
of flaws that cross many system calls. To perform this evaluation we configured
CrashSimulator to test whether an application properly performs the steps
required to move a file from location to another while preserving important
metadata. In Linux, the standard approach for moving a file, the {\tt rename()}
system
call, will work if the source and
...
This situation adds additional complexity that libraries and applications
...
{\bf Method.}  To identify the steps required to correctly move a file, 
