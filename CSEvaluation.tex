...
In our experience, applications that fail to perform this check end up can
...
Due to the level at which CrashSimulator works (the system call level), it is
...
anticipating to implement a given operation.  Fortunately, CrashSimulator's
