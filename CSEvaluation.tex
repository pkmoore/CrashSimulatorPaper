\section{Evaluation}
    ...
    \subsection{Bugs Identified}
       ...
       %  Next, CrashSimulator was run against these tools fault counts were collected. A comparison of the number of
       %  faults identified by the tool's users in the tool's bug tracker to the number of faults identified by
       %  CrashSimulator is presented in the table below.

       %  Select potential anomaly, come up with search terms, search for bugs, choose candidates, run crash simulator,
       %  determine if bugs were identified.
