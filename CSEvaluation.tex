...
Line count numbers are according to SLOCCOUNT\cappos{check}}.  For a test
...
\cappos{I think you are not organizing this in the best way.  It doesn't make
sense to me to separate this out in this way.  It should only be separated
out when you talk about the results. }
...
about the apps.  Some example text follows...}
