...
it was run on.  A second possibility is that CrashSimulator detects the
may have made an effort to respond and the application responds correctly in
...
reality the application fails in some way.  This is the case of ptx.
...
appears to be correct.  An example of this case is the case of pr above.
...
requires some investigation.  As it turns out, pr's error message occurs when a
