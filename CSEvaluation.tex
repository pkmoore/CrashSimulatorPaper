...
in the last three applications \phyllis{Is this correct?} listed in Table~\ref{table:unexpectedtypes}.  Each of these
...
session.} were vulnerable to this sort of anomaly, with timeouts taking hours or
...
%
\phyllis{I think these paragraphs about why it's important to deal with all
of these issues should be merged into the corresponding paragraphs 
a, b, c, d, above.}
